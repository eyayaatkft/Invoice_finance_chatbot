...
import { getActiveKnowledgeBaseUrl } from "../../utils/activeKnowledgeBase";
...
const Chatbot = forwardRef((props, ref) => {
  ...
  // Always get the latest active KB URL when chat is opened
  useEffect(() => {
    if (open) {
  ...
  const sendMessage = async (e: React.FormEvent) => {
    ...
    setInput("");
    try {
      console.log("Chat POST body:", { question: userMsg, url: activeUrl });
